...
def secret_field(value: str, *, label: str = "Secret", mask: str | None = None) -> str:
	...
	return (
		...
		"<img class=\"icon-btn__img\" src=\"/static/img/hidden.png\" alt=\"Hidden\" data-secret-icon-hidden>"
		"<img class=\"icon-btn__img\" src=\"/static/img/eye.png\" alt=\"Visible\" data-secret-icon-visible>"
		"</button>"
		"</div>"
	)
